            ...
            switch(e.type) 
            {
                ...
                case SDL_MOUSEBUTTONUP:
                    ...
                    if(e.button.button == SDL_BUTTON_RIGHT){
                        printf("lul coucou \n");
                        Primitive* primitive2 = allocPrimitive(GL_LINE_LOOP);
                       // 
                        addPrimitive(primitive2, &listeprimitives);
                        primitive2->points=primitive->points;
                    }
                ...
                case SDL_KEYDOWN: 
                    ...
                    if (e.key.keysym.sym == SDLK_l) {
                        primitive = allocPrimitive(GL_LINE_STRIP);
                        addPrimitive(primitive, &listeprimitives);
                    }
